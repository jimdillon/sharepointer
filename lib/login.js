...
module.exports = function(client) {
  ...
  return function(cb) {
    ...
    contextUrl = client.url + context + '/0d2fd93f-6cb4-4762-b9d7-879bacb49bd0/_api/contextinfo';
    var httpOpts = {
      url: contextUrl,
      method: 'post'
    };

    console.log('___contextUrl ' + contextUrl);
    ...
    return client.httpClient(client, httpOpts, function(err, response, body) {
      ...
      console.log('___context web information ' + JSON.stringify(body.GetContextWebInformation));
